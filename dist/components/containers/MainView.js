...
import { backgroundColor, borderRadius, overflow, zIndex, position, flexGrow, flexDirection, flexWrap, justifyContent, alignItems, alignContent, gap, height, minHeight, maxHeight, width, minWidth, maxWidth, shadow, } from "../../theme";
import { getSpacingStyles } from "../../utils/getSpacingStyles";
const MainView = ({ children, 
// Layout Defaults
bg = "primary", flexGrow: fg = "full", flexDirection: fd = "column", flexWrap: fw = "nowrap", justify = "start", alignItems: ai = "start", alignContent: ac = "start", gap: g = "lg", minHeight: mh = "md", padding = "md", 
// Style Overrides
height: h, maxHeight: maxH, width: w, minWidth: minW, maxWidth: maxW, zIndex: z, position: pos, borderRadius: br, overflow: of, shadow: shadowKey, 
// Spacing
margin, mt, mb, ml, mr, padding: p, pt, pb, pl, pr, 
// Custom
style, }) => {
    ...
    return <SafeAreaView style={mainStyles}>{children}</SafeAreaView>;
};
