...
const ScrollSection = ({ children, bg = "accent", borderRadius: br, overflow: of, shadow: shadowKey, padding, pt, pb, pl, pr, margin, mt, mb, ml, mr, style, }) => {
    ...
    return (<ScrollView contentContainerStyle={scrollStyles}>{children}</ScrollView>);
};
